...
INSERT INTO `STATION` (ID, CITY, STATES, LAT_N, LONG_W) VALUES
...
*/
SELECT COUNT(CITY)-COUNT(DISTINCT CITY) as differnece FROM `STATION`;
...
/*Q.14. list of CITY names from STATION that do not end with vowels.*/

SELECT DISTINCT CITY FROM STATION 
WHERE CITY RLIKE '[^AEIOUaeiou]$';

/*Q.15. Query the list of CITY names from STATION that either do not start with vowels or do not end
with vowels.*/

SELECT DISTINCT CITY FROM STATION 
WHERE CITY NOT RLIKE'^[AEIOUaeiou]'
OR
CITY NOT RLIKE '[^AEIOUaeiou]$';  #check

/* Q.16. list of CITY names from STATION that do not start with vowels and do not end with
vowels.*/
SELECT DISTINCT CITY FROM STATION 
WHERE CITY NOT RLIKE'^[AEIOUaeiou]$';
